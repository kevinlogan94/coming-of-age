...
Playable load-bearing: **Kevin, Steve, Lisa, Rachel, Nick**.  
...
- **Jigsaw puzzle** as examine gameplay — cut from MVP (scope/filler risk).
- **Stealth simulator** (Nick sneak scenario) — cut from MVP; may exist only as scripted dialogue/story beat if ever revisited.
